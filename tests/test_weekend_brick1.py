...
class TestLiveWiring:
    def test_default_production_sources_report_the_unattached_client_and_v2(self):
        ...
        assert "NOT ATTACHED" in d["wiring"]["bars_nbbo_client"] and d["fee_schedule"]["provenance"] == "UNVERIFIED"   # reverted: the fee computation changed (v2026-09-12b) and awaits review
