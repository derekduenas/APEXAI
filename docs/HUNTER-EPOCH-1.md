...
| Decision model (scanner, playbooks, forward pass, birth law, capital, forecast, memory, swarm, contracts, calendar) | hunter_rule_model_v1.5.7 (FINAL: + EDGE_PERSISTENCE_HORIZON semantics; prediction semantics frozen; predicates unchanged since v1) | 23:10Z |
